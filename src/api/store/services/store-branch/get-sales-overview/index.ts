...
export class GetStoreBranchSalesOverview {
...
const getStoreBranchSalesOverviewInstance = new GetStoreBranchSalesOverview(Store, StoreBranch);

export default getStoreBranchSalesOverviewInstance;
